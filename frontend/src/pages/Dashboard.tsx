      ...
      <DashboardContent>
          ...
          {isAdmin ? (
            <>
              ...
              <DashboardCard>
                ...
                <CardButton to="/admin/users" $secondary>
                  Manage Users
                </CardButton>
              </DashboardCard>
        ...
        <InfoBanner>
          ...
          <InfoContent>
            ...
            <InfoText>
              {isAdmin
                ? 'As an administrator, you can manage users, create question groups, design document templates, and merge completed documents.'
